...
export const dictionaries = {
  en: {
    ...
    'allProjects.all': 'All',
    'allProjects.filterBy': 'Filter by technology',
  ...
  id: {
    ...
    'allProjects.filterBy': 'Filter berdasarkan teknologi',
    'allProjects.empty': 'Tidak ada proyek yang sesuai dengan filter.',
